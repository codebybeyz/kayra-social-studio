...
import { ArrowDownRight, ArrowUpRight, Check, ChevronDown, Compass, Dribbble, Eye, Figma, Instagram, Linkedin, Mail, MapPin, Menu, MousePointer2, PenTool, Send, Sparkles, X, Youtube } from 'lucide-react';
    ...
    <main className="studio-shell min-h-[100dvh] bg-[#f3faff] text-[#252946]">
      ...
      <section id="contact" className="bg-[#f3faff] py-28 md:py-40">
        <div className="section-wrap grid gap-16 md:grid-cols-[.8fr_1.2fr] md:gap-24">
          <Reveal><p className="eyebrow">07 / Contact</p><h2 className="mt-7 font-serif text-[clamp(3rem,6vw,5.8rem)] leading-[.94] tracking-[-.055em]">Let's work<br /><em className="text-[#7774a6]">together.</em></h2><p className="mt-8 max-w-[310px] text-sm leading-7 text-[#777a92]">Aklınızdaki projeyi, ihtiyacı veya sadece fikri anlatın. Size geri dönüş yapmak için formu doldurabilirsiniz.</p><div className="mt-10 grid max-w-[360px] gap-5 border-t border-[#d4d5e1] pt-6"><a href="mailto:ekinkayrayanik@gmail.com" className="group flex items-start gap-3 text-[#7774a6] transition-colors hover:text-[#252946]" aria-label="ekinkayrayanik@gmail.com adresine e-mail gönder" data-testid="link-email"><Mail size={18} strokeWidth={1.5} className="mt-0.5 shrink-0" /><span><span className="block font-mono text-[9px] uppercase tracking-[.16em] text-[#9b9db0]">E-mail</span><span className="mt-1 block text-sm text-[#4f5472]">ekinkayrayanik@gmail.com</span></span></a><div className="flex items-start gap-3 text-[#7774a6]"><MapPin size={18} strokeWidth={1.5} className="mt-0.5 shrink-0" /><span><span className="block font-mono text-[9px] uppercase tracking-[.16em] text-[#9b9db0]">Location</span><span className="mt-1 block text-sm text-[#4f5472]">Antalya / Konyaaltı</span></span></div></div><div className="mt-8 flex items-center gap-4 text-[#7774a6]"><a href="#" onClick={(event) => event.preventDefault()} aria-label="Instagram bağlantısı yakında" className="transition-colors hover:text-[#252946]" data-testid="link-instagram"><Instagram size={18} strokeWidth={1.5} /></a><a href="#" onClick={(event) => event.preventDefault()} aria-label="LinkedIn bağlantısı yakında" className="transition-colors hover:text-[#252946]" data-testid="link-linkedin"><Linkedin size={18} strokeWidth={1.5} /></a><a href="#" onClick={(event) => event.preventDefault()} aria-label="Dribbble bağlantısı yakında" className="transition-colors hover:text-[#252946]" data-testid="link-dribbble"><Dribbble size={18} strokeWidth={1.5} /></a></div></Reveal>
      ...
      <footer className="bg-[#252946] py-12 text-[#f7f8fc] md:py-14">
        <div className="section-wrap">
          <div className="flex flex-col justify-between gap-12 md:flex-row md:items-start">
            <div><a href="#home" data-testid="link-footer-brand"><img src="/assets/kayra-logo.png" alt="KAYRA SOCIAL STUDIO" className="logo-img rounded-[3px]" /></a><p className="mt-5 font-serif text-lg italic text-[#c9c2ff]">Creative digital studio.</p><a href="mailto:ekinkayrayanik@gmail.com" className="mt-5 block text-sm text-[#babdd0] transition-colors hover:text-white" data-testid="link-footer-email-text">ekinkayrayanik@gmail.com</a><p className="mt-2 text-sm text-[#babdd0]">Antalya / Konyaaltı</p></div>
